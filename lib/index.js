...
const convertsTensOfThousandsToWords = (userInput) => {
    ...
    if (userInput % 10000) {
        result.push(`and ${numbersToWords(userInput % 10000)}`);
    }
    return result.join(' ');
...
const numbersToWords = (userInput) => {
    ...
    if (checkIfValidNumber(userInput)) {
        if (userInput < 20) {
            ...
            convertedIntoWords.push(`${magnitudes[Math.floor(userInput / 1000)]},`);
...
console.log(numbersToWords(10000));
console.log(numbersToWords(10001));
console.log(numbersToWords(99999));
console.log(numbersToWords(100000));
